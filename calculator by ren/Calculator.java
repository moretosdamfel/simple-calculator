...
public class Calculator extends Frame implements ActionListener {
    ...
    public Calculator() {
        ...
        setTitle("Calculator by rens");
        setResizable(false);
        setBounds(800, 200, 360, 500);
        
        // Adding a soft pink background to the frame
        Color bgPink = new Color(255, 240, 245); // Lavender blush
        setBackground(bgPink);

        // Create a panel to hold the buttons and text field
        Panel panel = new Panel();
        panel.setLayout(new GridLayout(5, 4, 5, 5));
        panel.setBackground(bgPink);
        ...
        Color textDark = new Color(70, 0, 30); // Dark maroon/pink for contrast
        
        buttonPlus.setBackground(hotPink);
        buttonPlus.setForeground(textDark);
        buttonMinus.setBackground(hotPink);
        buttonMinus.setForeground(textDark);
        buttonMultiply.setBackground(hotPink);
        buttonMultiply.setForeground(textDark);
        buttonDivide.setBackground(hotPink);
        buttonDivide.setForeground(textDark);
        buttonPercent.setBackground(hotPink);
        buttonPercent.setForeground(textDark);
        buttonSquareRoot.setBackground(hotPink);
        buttonSquareRoot.setForeground(textDark);
        buttonClear2.setBackground(hotPink);
        buttonClear2.setForeground(textDark);
        buttonClear.setBackground(hotPink);
        buttonClear.setForeground(textDark);
        buttonDot.setBackground(hotPink);
        buttonDot.setForeground(textDark);

        buttonEqual.setBackground(deepPink);
        buttonEqual.setForeground(Color.WHITE);
        
        button0.setBackground(lightPink);
        button0.setForeground(textDark);
        button1.setBackground(lightPink);
        button1.setForeground(textDark);
        button2.setBackground(lightPink);
        button2.setForeground(textDark);
        button3.setBackground(lightPink);
        button3.setForeground(textDark);
        button4.setBackground(lightPink);
        button4.setForeground(textDark);
        button5.setBackground(lightPink);
        button5.setForeground(textDark);
        button6.setBackground(lightPink);
        button6.setForeground(textDark);
        button7.setBackground(lightPink);
        button7.setForeground(textDark);
        button8.setBackground(lightPink);
        button8.setForeground(textDark);
        button9.setBackground(lightPink);
        button9.setForeground(textDark);
        ...
        display.setBackground(new Color(255, 228, 225)); // Misty Rose (very light pink)
        display.setForeground(textDark);
